    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a  style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ankita,Aman,Meeraj</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9165063741</h4>
		<h4 style="font-family:'typo' ">sampleproject@gmail.com</h4>
		<h4 style="font-family:'typo' ">SRM Insitute of Science & Technology ,Chennai</h4></div></div>
		</p>
      </div>
